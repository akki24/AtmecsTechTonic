                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>ATMECS Tech Talk</strong> Register Forms</h1>
                            <div class="description">
                            	<p>
	                            	Please Sign up for better Usage	
                            	</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-6">
                        	...
                        	<div class="form-box">
	                            ...
	                            <div class="form-bottom">
				                    <form role="form" action="RegisterController" method="post" class="registration-form">
				                    	<div class="form-group">
				                        	<label class="sr-only" for="form-email">Email</label>
				                        	<input type="text" name="email" placeholder="Email..." class="form-email form-control" ng-model="email" pattern="[a-z0-9._%+-]+@atmecs.com$" id="form-email">
				                        ...
				                        <div class="form-group">
				                        	...
				                        	<input type="password" name="password" placeholder="Password..." pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" class="form-password form-control" id="form-password">
